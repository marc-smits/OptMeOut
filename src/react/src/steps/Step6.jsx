        ...
        <div className="col-8">
          ...
          <div className="social flex-center">
            <div className="social-inner">
              ...
              <ul>
                <a
                  href={`https://twitter.com/intent/tweet?url=&url=${baseUrl}&text=${encodedMessage}`}
                >
                  <li>
                ...
                <a
                  href={`https://www.linkedin.com/shareArticle?mini=true&url=${baseUrl}&title=${encodedMessage}`}
                >
                  <li>
                    <div className="socialIcon">
                      <LinkedInSvg />
                ...
                <a
                  href={`http://www.reddit.com/submit?url=${baseUrl}&title=${encodedMessage}`}
                >
                  <li>
                    <div className="socialIcon">
                      <RedditSvg />
                ...
                <a
                  href={`mailto:email@adress.somewhere?subject=OptMeOut!&body=%0D%0A${message}%0D%0A%0D%0A${baseUrl}`}
                >
                  <li>
                    <div className="socialIcon">
                      <EmailSvg />
                ...
                <a href="#" onClick={handleCopyLink}>
                  <li>
                    ...
                    <div className="socialName" data-copied={dataCopied}>
                      {copyLink}
                    </div>
                  </li>
                </a>
