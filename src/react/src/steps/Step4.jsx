          ...
          <div className="letter">
            <div className="letterAddress">
              <div className="recipient">
                <p>
                  {props.formData.recipientOrganization}
                  <br />
                  ...
                  <br />
                  {props.formData.recipientAddress2}
                  <br />
                  {props.formData.recipientCity}
                  <br />
                  {props.formData.recipientCountry}
                  <br />
                </p>
              </div>
              <div className="sender">
                <p>
                  <strong>[[opt-me-out-letter.from]]</strong>
                  <br />
                  {props.formData.senderFirstName}{" "}
                  {props.formData.senderLastName}
                  <br />
                  {props.formData.senderAddress1}
                  <br />
                  {props.formData.senderAddress2}
                  <br />
                  {props.formData.senderCity}
                  <br />
                  {props.formData.senderCountry}
                  <br />
                </p>
                <p>
                  [[opt-me-out-letter.senderBirthDate]]{" "}
                  {props.formData.senderBirthDate}
                  <br />
                  [[opt-me-out-letter.senderId]]: {props.formData.senderId}
                  <br />
                  [[opt-me-out-letter.senderPhone]]:{" "}
                  {props.formData.senderPhone}
                  <br />
                  [[opt-me-out-letter.senderEmail]]:{" "}
            ...
            <div className="letterMeta">
              <p>
                <strong>[[opt-me-out-letter.date]]: </strong>
                <LocalDate localeCode={props.formData.locale} />
                <br />
                <strong>[[opt-me-out-letter.subject]]: </strong>
                [[opt-me-out-letter.letter-subject]]
              </p>
            </div>
            <div
              className={
                readMore1 ? "letterBody fadeIn" : "letterBody readLess"
              }
            >
              {props.formData.recipientLastName != "" && (
                <p>
      ...
      <div className="row">
        <div className="col col-8">
          ...
          <div className="donate flex-center">
            <div
              className="donateOption"
              data-selected={paymentOption === 1 ? "true" : "false"}
            >
              <div
                className="button buttonDonate"
                onClick={(e) => selectDonation(1, e)}
              >
                &euro;0.01
              </div>
              <div className="donateLabel">
                [[step4.donate.paymentOptions.1]]
              </div>
            </div>

            <div
              className="donateOption"
              data-selected={paymentOption === 2 ? "true" : "false"}
            >
              <div
                className="button buttonDonate"
                onClick={(e) => selectDonation(2, e)}
              >
                &euro;2
              </div>
              <div className="donateLabel">
                [[step4.donate.paymentOptions.2]]
              </div>
            </div>

            <div
              className="donateOption"
              data-selected={paymentOption === 3 ? "true" : "false"}
            >
              <div
                className="button buttonDonate"
                onClick={(e) => selectDonation(3, e)}
              >
                &euro;4
              </div>
              <div className="donateLabel">
                [[step4.donate.paymentOptions.3]]
              </div>
            </div>

            <div
              className="donateOption"
              data-selected={paymentOption === 4 ? "true" : "false"}
            >
              <div
                className="button buttonDonate"
                onClick={(e) => selectDonation(4, e)}
              >
                &euro;10
              </div>
              <div className="donateLabel">
                [[step4.donate.paymentOptions.4]]
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="row">
        <div className="col flex-center">
          <div
            ...
            onClick={(e) => props.emitChangeSection("step3", e)}
          >
            <BackSvg />
            [[button.back]]
          </div>
          ...
          <div
            className="button buttonOptMeOut"
            disabled={disableNextStep}
            onClick={!disableNextStep ? (e) => onSubmit() : void 0}
          >
            [[button.send]]
          </div>
        </div>
