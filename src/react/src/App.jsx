...
function App() {
  ...
  const [sectionFromQueryParamsSet, setSectionFromQueryParamsSet] =
    useState(false);
    ...
    <>
      ...
      <div id="mainContent">
        ...
        {currentSection == "splash" && (
          <Splash emitChangeSection={changeSection} />
        )}
        ...
        {currentSection == "about" && (
          <About emitChangeSection={changeSection} />
        )}

        {/* Step 1 Introduction*/}
        {currentSection == "step1" && (
          <Step1 emitChangeSection={changeSection} />
        )}
        ...
        {currentSection == "privacyPolicy" && (
          <PrivacyPolicy emitChangeSection={changeSection} />
        )}
        ...
        {/* Step6 -- Thankyou */}
        {currentSection == "step6" && <Step6 />}

        {/* Error section */}
        {currentSection == "error" && (
          <Error formData={formData} emitChangeSection={changeSection} />
        )}
      </div>
